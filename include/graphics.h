...
extern const u8 gMonIcon_Toxtricity_Low_key[];
//extern const u8 gMonIcon_Sinistea_Antique[];
//extern const u8 gMonIcon_PolteaGeist_Antique[];
extern const u8 gMonIcon_Alcremie_ruby[];
extern const u8 gMonIcon_Alcremie_matcha[];
extern const u8 gMonIcon_Alcremie_mint[];
extern const u8 gMonIcon_Alcremie_lemon[];
...
extern const u8 gMonIcon_Eiscue_noice_face[];
extern const u8 gMonIcon_Indeedee_F[];
extern const u8 gMonIcon_Morpeko_Hangry[];
extern const u8 gMonIcon_Zacian_Crowned_Sword[];
extern const u8 gMonIcon_Zamazenta_Crowned_Shield[];
//extern const u8 gMonIcon_Eternatus_Eternamax[];
extern const u8 gMonIcon_Urshifu_Rapid[];
//extern const u8 gMonIcon_Zarude_Dada[];
//extern const u8 gMonIcon_Calyrex_Ice_Rider[];
...
// item_menu_icons	   ok realized I've replaced my items.h so now these constants don't match
// So I need to replace the items listed here as well.
//luckily it seems these aren't referenced in function, just the items page, so I only need to replace them here.
