...
{  // REMOVED specific map evolution cause don't know how to doit, replaced with general map evolution with mapsec
    ...
    [SPECIES_MAGNETON] = {{EVO_MAPSEC, MAPSEC_CERULEAN_CAVE, SPECIES_MAGNEZONE}, // may change to victory road
    ...
    [SPECIES_RHYDON] = {{EVO_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR}}, // need to change all evo trade item to evo_item
    ...
    [SPECIES_EEVEE] = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                       ...
                                       {EVO_MAPSEC, MAPSEC_VIRIDIAN_FOREST, SPECIES_LEAFEON}, //
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_LEAFEON},
                                       {EVO_MAPSEC, MAPSEC_SEAFOAM_ISLANDS, SPECIES_GLACEON}, //
   ...
   // [SPECIES_AIPOM] = {{EVO_MOVE, MOVE_DOUBLE_HIT, SPECIES_AMBIPOM}},
    ...
    [SPECIES_NOSEPASS] = {{EVO_MAPSEC, MAPSEC_MT_MOON, SPECIES_PROBOPASS}}, //
    ...
    [SPECIES_CHARJABUG] = {{EVO_MAPSEC, MAPSEC_POWER_PLANT, SPECIES_VIKAVOLT}, //
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_VIKAVOLT}},
    [SPECIES_CRABRAWLER] = {{EVO_MAPSEC, MAPSEC_SEAFOAM_ISLANDS, SPECIES_CRABOMINABLE}}, //
   ...
   // [SPECIES_POIPOLE] = {{EVO_MOVE, MOVE_DRAGON_PULSE, SPECIES_NAGANADEL}},
    ...
    [SPECIES_SINISTEA] = {{EVO_ITEM, ITEM_NONE, SPECIES_POLTEAGEIST}}, // LOOK INTO HOW these item_none evolve
    ...
    [SPECIES_PONYTA_GALARIAN] = {{EVO_LEVEL, 40, SPECIES_RAPIDASH_GALARIAN}}, //shouldnt this be galarian rapidash?
