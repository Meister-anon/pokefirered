...
const u32 gMonFrontPic_Unown[] = INCBIN_U32("graphics/pokemon/unown/a/front.4bpp.lz");
const u32 gMonPalette_Unown[] = INCBIN_U32("graphics/pokemon/unown/normal.gbapal.lz");
const u32 gMonBackPic_Unown[] = INCBIN_U32("graphics/pokemon/unown/a/back.4bpp.lz");
const u32 gMonShinyPalette_Unown[] = INCBIN_U32("graphics/pokemon/unown/shiny.gbapal.lz");
const u8 gMonIcon_Unown[] = INCBIN_U8("graphics/pokemon/unown/a/icon.4bpp");
...
//const u8 gMonIcon_Regieleki[] = INCBIN_U8("graphics/pokemon/reieleki/icon.4bpp");
...
const u8 gMonIcon_Toxtricity_Low_key[] = INCBIN_U8("graphics/pokemon/toxtricity/low_key/icon.4bpp");
//const u8 gMonIcon_Sinistea_Antique[] = INCBIN_U8("graphics/pokemon/sinistea/antique/icon.4bpp");
//const u8 gMonIcon_PolteaGeist_Antique[] = INCBIN_U8("graphics/pokemon/polteageist/antique/icon.4bpp");
const u8 gMonIcon_Alcremie_ruby[] = INCBIN_U8("graphics/pokemon/alcremie/ruby_cream/icon.4bpp");
const u8 gMonIcon_Alcremie_matcha[] = INCBIN_U8("graphics/pokemon/alcremie/matcha_cream/icon.4bpp");
const u8 gMonIcon_Alcremie_mint[] = INCBIN_U8("graphics/pokemon/alcremie/mint_cream/icon.4bpp");
const u8 gMonIcon_Alcremie_lemon[] = INCBIN_U8("graphics/pokemon/alcremie/lemon_cream/icon.4bpp");
const u8 gMonIcon_Alcremie_salt[] = INCBIN_U8("graphics/pokemon/alcremie/salted_cream/icon.4bpp");
const u8 gMonIcon_Alcremie_ruby_swirl[] = INCBIN_U8("graphics/pokemon/alcremie/ruby_swirl/icon.4bpp");
const u8 gMonIcon_Alcremie_caramel_swirl[] = INCBIN_U8("graphics/pokemon/alcremie/caramel_swirl/icon.4bpp");
const u8 gMonIcon_Alcremie_rainbow_swirl[] = INCBIN_U8("graphics/pokemon/alcremie/rainbow_swirl/icon.4bpp");
const u8 gMonIcon_Eiscue_noice_face[] = INCBIN_U8("graphics/pokemon/eiscue/noice_face/icon.4bpp");
const u8 gMonIcon_Indeedee_F[] = INCBIN_U8("graphics/pokemon/indeedee/female/icon.4bpp");
const u8 gMonIcon_Morpeko_Hangry[] = INCBIN_U8("graphics/pokemon/morpeko/hangry/icon.4bpp");
const u8 gMonIcon_Zacian_Crowned_Sword[] = INCBIN_U8("graphics/pokemon/zacian/crowned_sword/icon.4bpp");
const u8 gMonIcon_Zamazenta_Crowned_Shield[] = INCBIN_U8("graphics/pokemon/zamazenta/crowned_shield/icon.4bpp");
//const u8 gMonIcon_Eternatus_Eternamax[] = INCBIN_U8("graphics/pokemon/eternatus/eternamax/icon.4bpp");
const u8 gMonIcon_Urshifu_Rapid[] = INCBIN_U8("graphics/pokemon/urshifu/rapid_strike_style/icon.4bpp");
//const u8 gMonIcon_Zarude_Dada[] = INCBIN_U8("graphics/pokemon/zaruda/dada/icon.4bpp");
//const u8 gMonIcon_Calyrex_Ice_Rider[] = INCBIN_U8("graphics/pokemon/calyrex/ice_rider/icon.4bpp");
//const u8 gMonIcon_Calyrex_Shadow_Rider[] = INCBIN_U8("graphics/pokemon/calyrex/shadow_rider/icon.4bpp");
...
const u8 gMonIcon_MoltresGalarian[] = INCBIN_U8("graphics/pokemon/moltres/galarian/icon.4bpp"); //need to add galaraian pokemon icons.
...
const u8 gMonIcon_SlowpokeGalarian[] = INCBIN_U8("graphics/pokemon/slowpopke/galarian/icon.4bpp");
