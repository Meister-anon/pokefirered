...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_UNOWN_QMARK] = gMonIcon_Unown_QuestionMark, //ok I see now part of problem, this doeesn't have a comma and others are misaligned.
    ...
    [SPECIES_MR_RIME] = gMonIcon_Mr_Rime,
    ...
    //  [SPECIES_REGIELEKI]                       = gMonIcon_Regieleki,
      ...
      [SPECIES_MR_MIME_GALARIAN] = gMonIcon_Mr_MimeGalarian,
      [SPECIES_ARTICUNO_GALARIAN] = gMonIcon_ArticunaGalarian,
      ...
      [SPECIES_CRAMORANT_GULPING] = gMonIcon_Cramorant_Gulping,
      [SPECIES_CRAMORANT_GORGING] = gMonIcon_Cramorant_Gorging,
      [SPECIES_TOXTRICITY_LOW_KEY] = gMonIcon_Toxtricity_Low_key,
      /*    [SPECIES_SINISTEA_ANTIQUE]                = gMonIcon_Sinistea_Antique,
          [SPECIES_POLTEAGEIST_ANTIQUE]             = gMonIcon_PolteaGeist_Antique,
          [SPECIES_ALCREMIE_RUBY_CREAM] = gMonIcon_Alcremie_ruby,
          [SPECIES_ALCREMIE_MATCHA_CREAM] = gMonIcon_Alcremie_matcha,
          [SPECIES_ALCREMIE_MINT_CREAM] = gMonIcon_Alcremie_mint,
          [SPECIES_ALCREMIE_LEMON_CREAM] = gMonIcon_Alcremie_lemon,
          [SPECIES_ALCREMIE_SALTED_CREAM] = gMonIcon_Alcremie_salt,
          [SPECIES_ALCREMIE_RUBY_SWIRL] = gMonIcon_Alcremie_ruby_swirl,
          [SPECIES_ALCREMIE_CARAMEL_SWIRL] = gMonIcon_Alcremie_caramel_swirl,
          [SPECIES_ALCREMIE_RAINBOW_SWIRL] = gMonIcon_Alcremie_rainbow_swirl, */
          [SPECIES_EISCUE_NOICE_FACE] = gMonIcon_Eiscue_noice_face,
          [SPECIES_INDEEDEE_FEMALE] = gMonIcon_Indeedee_F,
          [SPECIES_MORPEKO_HANGRY] = gMonIcon_Morpeko_Hangry,
          [SPECIES_ZACIAN_CROWNED_SWORD] = gMonIcon_Zacian_Crowned_Sword,
          [SPECIES_ZAMAZENTA_CROWNED_SHIELD] = gMonIcon_Zamazenta_Crowned_Shield,
          //   [SPECIES_ETERNATUS_ETERNAMAX]             = gMonIcon_Eternatus_Eternamax,
             [SPECIES_URSHIFU_RAPID_STRIKE_STYLE] = gMonIcon_Urshifu_Rapid, //think last value needs no comma, nope doesn't matter but using comma is better in case you plan to add more
